...
public:
    ...
    void display() {
        ...
        cout << "........................................................................................................................\n";
        cout << "ID IS " << idpassword.first << endl << "PASSWORD IS ";
...
cout<<endl;cout<<endl;cout<<endl;cout<<endl;
    cout<<"Welcome aboard the future of urban mobility! Step into the dynamic world of the Noida Metro System, where seamless journeys and efficient ";cout<<endl;cout<<endl;
...
print(adjlist);
    ...
    if (reply) {
       cout<<"NICE !! , NOW LOGIN INTO THE SYSYEM BY FILLING YOUR CREDENTIALS \n";
        string password;int id ;string name;
        ...
        string password; int id = rand() % 100; string name;
        int card = rand() % 224;
   ...
   int source ,destination ;string s ,d;
    ...
    cout<<"\n \n \n so the distance that is possible between your source and destination is "<<endl<<endl;
         cout<<"                                    "<<sum<<"km"<<endl;
         cout<<s<<"----------------------------------------------------------------------------------------"<<d<<endl;
         float time=sum/45.0;
         cout<<"estimated time is - ";convertToStandardTime(time);
    ...
    cout<<"\n \n \n so the distance that is possible between your source and destination is "<<endl<<endl;
        ...
        else if(choice==4)
        {
         ...
         cout<<"\n \n \n so the shortest distance that is possible between your source and destination is "<<endl<<endl;
        ...
        //<<" now the balance is :- \n ";
         userdetails[currentusernumber].display();
          ...
          {
              cout<<endl << "ok , so tell us which station you want to visit in between of your journey  ";
              cout<<endl<<"(kindly , write station number )\n";
              int midwala;
              cin >>midwala;
              int cm=-1;
              int ui=0;
